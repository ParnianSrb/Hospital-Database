...
def dr_view_all():
    ...
    frame = Frame(dr_window, bg='light green', bd=4, relief='sunken', height=400)
    frame.grid(row=11, column=0, columnspan=2, pady=15)

    id_label = Label(frame, text='ID', bg='light green', justify='left', padx=65)
    id_label.grid(row=0, column=0, pady=5)

    name_label = Label(frame, text='Name', bg='light green', justify='left', padx=65)
    name_label.grid(row=0, column=1, pady=5)

    lname_label = Label(frame, text='Family', bg='light green', justify='left', padx=65)
    lname_label.grid(row=0, column=2, pady=5)
    ...
    for record in records:
        ...
        label_0 = Label(frame, text=str(record[0]), bg='light green', justify='left', padx=65)
        label_0.grid(row=counter, column=0, pady=5)

        label_1 = Label(frame, text=str(record[1]), bg='light green', justify='left', padx=65)
        label_1.grid(row=counter, column=1, pady=5)

        label_2 = Label(frame, text=str(record[2]), bg='light green', justify='left', padx=65)
        label_2.grid(row=counter, column=2, pady=5)
        counter += 1

    # view_label_dr = Label(frame, text=print_records, bg='light green')
    # view_label_dr.grid(row=1, column=0, pady=5)
